# 컷 10 — 시점숏 → 크레인 풀백 (상승 리빌, 엔딩)

- **카메라/구도:** 시점숏 → 크레인 풀백, 상승하며 학교 앞 동네 전체 리빌. 정문 제때 도착.
- **LOCK:** STYLE · LOCATION · LIGHT · ESCALATOR
- **VARY (이 컷에서만):** 학교 정문에 제때 도착, 동네 전체 리빌, 환하게 활짝 웃음, 빛내림
- **대사·SFX:** 💬 C1 "우와—! 안 늦겠다!"
- **클립:** E5 (멀티샷: 탑승 → 크레인 리빌 / 엔딩)

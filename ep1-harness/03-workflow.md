...
|---|---|---|
| 슬롯1 | §B-1 캐릭터 시트 | "keep the man's face, glasses, hair and 2-layer outfit exactly as reference 1" |
| 슬롯2 | §B-3 로케이션 키 비주얼 | "use reference 2 for the alley layout, mood and light direction; repaint in the same style" |
...
- 고정 문구 항상 포함:
  ```
  maintain the same elderly man's face from the reference, Makoto Shinkai anime style, consistent lighting from upper-left
  ```
...
- 의심되면 10컷 키프레임을 한 화면에 나란히 놓고 '같은 사람·같은 아침인가' 육안 검수.

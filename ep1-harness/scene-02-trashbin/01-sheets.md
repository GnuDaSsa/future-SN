# §B. 기준 시트 — 씬2 최우선 생성물 (4종)

> 캐릭터·소품·로케이션 + **쓰레기통 에셋** 시트를 먼저 확정한 뒤 10컷을 만든다.
> 쓰레기통은 이 씬의 메인 식별 닻이라 **에셋 시트(B-4)** 를 꼭 먼저 고정한다.
...
```
**🔎 검수:** 베이지 트렌치 · 낮은 포니테일 · 갈색 숄더백 · 한 손 컵+한 손 봉지 · 흰 운동화가 4뷰 동일한가.
...
```
**🔎 검수:** 광원 좌상단 · 대로변 넓은 인도 · 가로수 · 버스정류장 · 횡단보도.
...
> 📸 실제 사진 첨부 권장: `https://t1.daumcdn.net/news/202507/23/seouleconomy/20250723083834835wppw.jpg`

---
> 시트(특히 B-1·B-4) 확정 후 → `shots/cut-01.md`부터 키프레임 생성.

# 컷 03 — 책가방 끈 쥔 손·어깨 익스트림 클로즈업

- **카메라/구도:** 빨간 책가방 끈을 쥔 작은 손·어깨 익스트림 클로즈업.
- **LOCK:** CHARACTER (가방·손) + STYLE · LOCATION · LIGHT
- **VARY (이 컷에서만):** 무거운 빨간 가방을 추켜올리며 끈을 고쳐 쥐는 손
- **대사·SFX:** 💬 C1 "헉… 늦겠다…"
- **클립:** E2 (멀티샷 빌드업)

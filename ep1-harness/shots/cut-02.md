# 컷 02 — 웜즈아이 로우앵글 / 발 클로즈업

- **카메라/구도:** 웜즈아이 로우앵글, 발 클로즈업. 흰 운동화가 계단 한 칸을 오름.
- **LOCK:** STYLE · CHARACTER · LOCATION · LIGHT (全 LOCK)
- **VARY (이 컷에서만):** 흰 운동화만 프레임에, 무거운 한 걸음으로 계단 한 칸을 디딤
- **대사·SFX:** SFX — 발걸음, 가쁜 숨
- **클립:** E2 (멀티샷 빌드업: 발→가방끈→시선→표정)
